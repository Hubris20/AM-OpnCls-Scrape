...
def extract_book_details(book_url):
    ...
    product_type = table.find('th', string='Product Type').find_next('td').get_text(strip=True)
    price = table.find('th', string='Price (incl. tax)').find_next('td').get_text(strip=True)
    tax = table.find('th', string='Tax').find_next('td').get_text(strip=True)
    availability = table.find('th', string='Availability').find_next('td').get_text(strip=True)
    num_reviews = table.find('th', string='Number of reviews').find_next('td').get_text(strip=True)
